...
import { getUsername, getMessages, Message, getAvatar } from 'lib/appwrite';
...
const AdContact = () => {
  ...
  const sendMessage = async () => {
    if (!user?.userId || !adCreator || !messageText.trim()) {return; }
    try {
  ...
  const ChatHeader = () => (
    <View style={styles.headerContainer}>
      <TouchableOpacity style={styles.backButton}>
        <ButtonComponent theme='back' label='powrót' onPress={() => router.back()} /> 
      </TouchableOpacity>
